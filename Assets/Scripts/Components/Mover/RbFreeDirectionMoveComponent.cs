...
public class RbFreeDirectionMoveComponent : MoverComponent, IDirectionMoverComponent, ITargetMoverComponent
{
    ...
    [SerializeField] bool maxSpeelAlways;
    ...
    private void Update()
    {
        if (IsTargetSet)
        {
            ...
            Direction = SteeringBehaviour.Arriving(this, Direction, TargetPosition, distanceToArriveAtTargetLocation, distanceThreshold);
        ...
        Debug.DrawLine(_rb.transform.position, _movement.LastDirectionFacing.normalized + _rb.transform.position, Color.blue);
